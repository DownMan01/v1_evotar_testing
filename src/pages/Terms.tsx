      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-primary via-primary-600 to-primary-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed px-2">
            Please read these terms carefully. By using Evotar, you agree to these conditions.
          </p>
          <p className="text-white/80 mt-3 md:mt-4 text-sm md:text-base">Last updated: January 2025</p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-12">
                ...
                <CardContent className="space-y-4">
                  <div>
                     ...
                     <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                       <li>You must be a student or staff member of an educational institution using our platform</li>
                       <li>You must have the appropriate role (Voter, Staff, Admin) assigned by your institution</li>
                       <li>You must be eligible to participate in the specific elections for which you are voting</li>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                     ...
                     <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                       <li>Participate in authorized student elections based on your role</li>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                   <p className="text-muted-foreground">
                     All content, features, and functionality of the Evotar student voting platform, including 
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Our total liability for any claims related to the platform shall not exceed the amount paid by 
                    your institution for the services during the twelve months preceding the claim.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    You may terminate your account at any time by contacting your institution's administrator. Upon 
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    ...
                    use of the platform shall be resolved through binding arbitration or in the courts of [Jurisdiction].
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 text-muted-foreground">
                    <p><strong>Email:</strong> legal@evotar.com</p>
                    <p><strong>Address:</strong> Evotar Legal Department, [Company Address]</p>
