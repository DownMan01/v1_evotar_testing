                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                   ...
                   <div className="space-y-2 text-muted-foreground">
                     <p><strong>Email:</strong> evotar@sjcsi.edu.ph</p>
                     <p><strong>Address:</strong> SJCSI Legal Department, Saint Joseph College of Sindangan, Inc.</p>
                     <p><strong>Phone:</strong> Contact SJCSI Main Office</p>
                   </div>
                </CardContent>
              </Card>
