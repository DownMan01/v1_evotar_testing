            ...
            <div className="space-y-12">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      student ID, and institutional affiliation when you register for an account.
                    </p>
                  </div>
                   <div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                    <li>With your educational institution (only participation data, not vote choices)</li>
              ...
              <Card>
                ...
                <CardContent>
                   <p className="text-muted-foreground">
                     ...
                     and comply with institutional requirements. Anonymized vote data is retained for audit 
                     purposes as required by election regulations. Personal account information is managed 
                     according to your institution's data retention policies.
                   </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 text-muted-foreground">
                    <p><strong>Email:</strong> privacy@evotar.com</p>
                    <p><strong>Address:</strong> Evotar Privacy Team, [Company Address]</p>
