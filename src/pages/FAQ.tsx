...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can reset your password using the 'Forgot Password' link on the login page. If you don't remember your email or username, contact your election administrator or institution's IT support for assistance."
    },
    {
      question: "Why can't I access the voting system?",
      answer: "There are several possible reasons: 1) The election may not have started yet, 2) The election may have ended, 3) You may not be registered for this specific election, 4) Your account may need verification, or 5) You may not have the required voter role. Check with your administrator if issues persist."
    },
    {
    ...
    },
    {
      ...
      answer: "If you experience technical difficulties, try refreshing your browser first. Your voting session is automatically saved, so you won't lose your progress. If issues persist, contact technical support immediately through your institution."
    },
    {
    ...
    },
    {
      ...
      answer: "To become a candidate, you typically need to register through your institution's process. Once registered, you'll submit your candidate information including bio, platform, and qualifications. Staff or admins will review and approve candidates before they appear in elections."
    }
  ];
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-primary via-primary-600 to-primary-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed px-2">
            Find answers to common questions about using Evotar for student elections and voting management.
          </p>
        </div>
      </section>
                ...
                <CardContent>
                  ...
                  <div className="space-y-2">
                    {category.items.slice(0, 2).map((item, itemIndex) => (
                      <p key={itemIndex} className="text-sm text-muted-foreground truncate">
                        • {item.question}
                      </p>
                    ))}
                  </div>
