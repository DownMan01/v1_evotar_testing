      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex">
        ...
        <div className="flex-1 flex flex-col lg:ml-64">
          ...
          <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-xl border-t border-border/50 z-50 safe-area-bottom">
            <div className="grid grid-cols-5 max-w-sm mx-auto px-2 py-1">
              {(profile?.role === 'Staff' ? [
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "flex flex-col items-center justify-center py-3 px-2 rounded-lg relative transition-all duration-200 active:scale-95 touch-manipulation",
                      isActive 
                  ...
                  >
                    ...
                    <span className={cn(
                      "text-xs font-medium leading-none max-w-full truncate",
          ...
          <main className="flex-1 p-4 md:p-6 lg:p-8 pb-24 lg:pb-8 overflow-y-auto min-h-0">
