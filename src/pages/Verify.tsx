    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20 p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          <div className="mx-auto h-20 w-20 rounded-full bg-primary/10 flex items-center justify-center shadow-sm">
            <CheckCircle className="h-8 w-8 text-primary" />
          </div>
          <h1 className="text-4xl font-bold text-primary tracking-tight">Vote Verified</h1>
          <p className="text-muted-foreground max-w-2xl mx-auto text-base">
            Your vote has been successfully verified and recorded. See the verified receipt details below.
          </p>
        </div>

        <Card className="border border-primary/20 shadow-sm rounded-2xl">
          <CardHeader>
        ...
        <Card className="border border-primary/20 shadow-sm rounded-2xl">
          ...
          <CardContent className="space-y-4">
            {verificationData.selected_candidates.map((item, idx) => (
              <div
                key={idx}
        ...
        <Card className="border border-primary/20 shadow-sm rounded-2xl">
          <CardContent className="p-6 space-y-6 text-center">
            <div className="mx-auto h-14 w-14 rounded-full bg-green-100 dark:bg-green-900/20 flex items-center justify-center">
        ...
        <div className="text-center">
          <Button asChild className="rounded-full px-6 py-2 text-base shadow-md hover:shadow-lg transition">
