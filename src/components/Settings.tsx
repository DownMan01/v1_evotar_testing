                  ...
                  <Dialog open={imageDialogOpen} onOpenChange={setImageDialogOpen}>
                    ...
                    <DialogContent className="max-w-4xl max-h-[90vh] overflow-auto">
                      ...
                      <div className="flex justify-center">
                        <img src={profile.id_image_url} alt="ID Image Full Size" className="max-w-full max-h-[70vh] object-contain rounded-lg" />
                      </div>
                    </DialogContent>
                  </Dialog>
                </div>
            ...
            <div className="space-y-4">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-medium p-2 bg-muted rounded">{profile?.year_level || 'N/A'}</p>
                </div>
