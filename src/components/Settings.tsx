...
export const Settings = () => {
  ...
  const handleVerifiedProfileUpdate = () => {
    ...
    handleProfileUpdate(fakeEvent);
  };

  const handleVerifiedPasswordChange = () => {
    const fakeEvent = { preventDefault: () => {} } as React.FormEvent;
    handlePasswordChange(fakeEvent);
  };
          ...
          <CardContent>
            ...
            <form onSubmit={handleProfileUpdate} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <Button type="button" disabled={loading} className="flex items-center gap-2">
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handlePasswordChange} className="space-y-4">
              ...
              <StepUpVerification
                onVerified={handleVerifiedPasswordChange}
              ...
              {historyLoading ? (
                ...
                <div className="max-h-96 overflow-y-auto space-y-3">
                  {userHistory.slice(0, 20).map((entry) => {
                    ...
                    return (
                       <div key={entry.id} className="border rounded-lg p-3 bg-card hover:shadow-sm transition-shadow">
