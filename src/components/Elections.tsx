...
export const Elections = () => {
  ...
  return <div className="space-y-4 lg:space-y-6 pb-4 lg:pb-0">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <h2 className="text-xl lg:text-2xl font-bold">Elections</h2>
        <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:gap-2">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              <span className="ml-2 lg:hidden">Refresh</span>
            </Button>
          </div>
        </div>
      </div>
             ...
             {filteredElections.map(election => (
               <Card key={election.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                   ...
                   <div className="flex items-start justify-between">
                     <div className="flex-1 min-w-0">
                       ...
                       <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:gap-3 mb-2">
                         <CardTitle className="text-base lg:text-xl font-semibold leading-tight">
                           {election.title}
                         </CardTitle>
                         <Badge className={`${getStatusColor(election.status)} w-fit text-xs`}>
                           {election.status}
                         </Badge>
                       </div>
                 ...
                 <CardContent className="pt-0 p-3 lg:p-6 lg:pt-0">
                   ...
                   <div className="flex flex-col gap-2 lg:flex-row lg:gap-2 lg:flex-wrap">
                     <Button 
                       variant="outline" 
