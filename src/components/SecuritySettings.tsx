...
export const SecuritySettings = () => {
  ...
  const { canUseTwoFactor, twoFactorEnabled, disableTwoFactor, loading } = useTwoFactor();
      ...
      <Card>
        ...
        <CardContent>
          <Alert>
            ...
            <AlertDescription>
              Two-factor authentication is only available for staff and administrator accounts.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
