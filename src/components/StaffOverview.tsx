    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6">
               ...
               <Card>
                 ...
                 <CardContent>
                   <div className="text-2xl font-bold text-accent-foreground">{loading ? '...' : stats.totalCandidates}</div>
               ...
               <Card>
                 ...
                 <CardContent>
                   <div className="text-2xl font-bold text-foreground">{loading ? '...' : stats.totalVotes}</div>
