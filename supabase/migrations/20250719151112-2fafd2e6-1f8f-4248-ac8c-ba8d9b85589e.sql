-- Add missing actor_role column to audit_logs table
ALTER TABLE public.audit_logs ADD COLUMN actor_role public.user_role;

-- Update the log_audit_action function to handle the correct parameter types
...
-- Update approve_pending_action function to use proper user_role casting
...
-- The approve_user_registration and reject_user_registration functions are already correct
-- but let's recreate them to ensure consistency
