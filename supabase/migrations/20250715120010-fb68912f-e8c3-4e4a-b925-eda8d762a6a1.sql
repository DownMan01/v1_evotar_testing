-- Update approve_pending_action function to handle pre-uploaded cover images
CREATE OR REPLACE FUNCTION public.approve_pending_action(p_action_id UUID, p_admin_notes TEXT DEFAULT NULL) RETURNS BOOLEAN
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
DECLARE
